...
public partial class Profile_profilec_pro_pic_change : System.Web.UI.Page
{
    Db dbClass = new Db();
    public DataSet ds;
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            if (ds.Tables[0].Rows[0]["Image"].ToString() != "")
            {
                ...
                Thumbnail.Width = Unit.Pixel(180);
                Thumbnail.Height = Unit.Pixel(350);
                Thumbnail.ResizeMode = BinaryImageResizeMode.Crop;
            }
            else
            {
