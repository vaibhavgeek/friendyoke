<%@ Control Language="C#" AutoEventWireup="true" CodeFile="settings.ascx.cs" Debug="true" Inherits="Space_message" %>
 ...
 <asp:Panel runat="server" CssClass="bottompane" BackColor="White" ID="Panel3">
  ...
  <a href="#">embed friendyoke!</a> 
                                       ...
                                       <a href="#"> in store </a> 
                                        ...
                                        designed by <a href="#"> vaibhav maheshwari </a>
 
 </asp:Panel>
 </td>
 <td valign="top">

 <asp:Panel runat="server" Width="815px" BackColor="White" ID="Panel2">
