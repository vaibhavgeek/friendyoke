...
<style type="text/css">
    ...
    <telerik:RadGrid ID="followingpp" runat="server" AutoGenerateColumns="False" 
                    Skin="Office2007" CssClass="rathibaba" Width="712px" 
        AllowPaging="True" GridLines="None" 
                     onneeddatasource="datasource" PageSize="6" 
        BorderColor="White" onitemcommand="followingpp_ItemCommand" >
                ...
                <telerik:GridTemplateColumn  HeaderText=""  HeaderStyle-CssClass="nfeedradgrid" UniqueName="MyBox" SortExpression="MyBox" HeaderStyle-BackColor="White" HeaderStyle-Height="0px">
                 <ItemTemplate><table>
                 <tr>
                 <td>
                 
                 <a href='Profile/profile.aspx?Id=<%# DataBinder.Eval(Container.DataItem, "ID") %>'>
                                        <telerik:RadBinaryImage ID="sompropic" style="margin-left:0px;" runat="server" CssClass="ppic" DataValue='<%# DataBinder.Eval(Container.DataItem, "Image") %>' Height="150px" Width="120px" ResizeMode="Fit" />
                                        </a>   </td>
                 <td>
            ...
            <telerik:RadToolTip runat="server" ID="detailstooltip" TargetControlID="det"  Position="MiddleRight" Animation="Resize" RelativeTo="Element" Skin="Outlook" Width="400px" Sticky="True">
                       ...
                       Facebook :
                              ...
                              <telerik:RadButton runat="server" ID="remove123" CommandName = "removeperson" Text="Remove From Box">
