<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Sent-Messages.ascx.cs" Inherits="Messages_Sent_Messages" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %><div style="height: 593px;">
...
<ExpandCollapseColumn FilterControlAltText="Filter ExpandColumn column">
    ...
    <Columns>
        ...
        <telerik:GridTemplateColumn FilterControlAltText="Filter TemplateColumn column" 
            UniqueName="TemplateColumn" HeaderText="To Whom?" >
            <ItemTemplate>
