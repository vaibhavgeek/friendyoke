...
<body class="body">
    ...
    <li><telerik:RadButton runat="server" Width="171px" ID="message" Text="Message" onclick="but3_Click" CommandName="ms"></telerik:RadButton></li>
    ...
    <td valign="top">
               ...
               <b> <asp:Label runat="server" ID="designationt" Text="Designation"></asp:Label></b>
                ...
                <div id="try">    </div>
                <asp:Panel runat="server" ID="eventlife" Width="527px">
               ...
               <div class="divXmlPanel">
                ...
                <asp:Panel runat="server" ID="locations" Width="527px">
      ...
      <telerik:RadTabStrip  ID="RadTabStrip1" 
            ...
            Skin="Office2007" style="position:fixed !important;">
                ...
                <telerik:RadTab runat="server" Text="Take me to Top" Selected="true" onclick="goToByScroll(&#39;form1&#39;)">
                    ...
                    <telerik:RadTab runat="server" Text="Events in Life" onclick="goToByScroll(&#39;eventlife&#39;)">
                    </telerik:RadTab>
                    <telerik:RadTab runat="server" Text="Locations" onclick="goToByScroll(&#39;locations&#39;)">
                    </telerik:RadTab>
